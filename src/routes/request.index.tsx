...
export const Route = createFileRoute("/request/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Request money from a friend, family member or business." },
    ],
  }),
});
...
const CONTACTS: Contact[] = [
  ...
  { name: "Aaron Nace", kind: "person", color: "bg-emerald-500" },
...
function RequestPage() {
  ...
  const choose = (recipient: string) => {
    navigate({ to: "/request/amount", search: { to: recipient } });
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 overflow-y-auto px-4 pb-6">
        ...
        {/* If query looks like email, offer continue */}
