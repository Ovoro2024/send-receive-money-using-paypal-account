  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <header className="relative flex items-center justify-center px-4 pt-5 pb-4">
        <Link to="/add-money/method" search={{ amount }} className="absolute left-4 top-5 text-[var(--pp-text)]">
      ...
      <main className="flex-1 flex flex-col px-7 pt-6">
        ...
        <div className="mt-10">
          <label className="flex items-center gap-3">
            <span className="flex h-5 w-5 items-center justify-center rounded-full border-2 border-[var(--pp-blue)]">
              <span className="h-2.5 w-2.5 rounded-full bg-[var(--pp-blue)]" />
            </span>
            <span className="text-[16px] font-medium text-[var(--pp-text)]">Receive a text</span>
          </label>
          ...
          <div className="mt-4 ml-8 flex items-center gap-3">
            ...
            <input
              ...
              className="h-11 flex-1 rounded-md border border-[color:var(--border)] bg-white px-3 text-[15px] text-[var(--pp-text)] outline-none focus:border-[var(--pp-blue)] focus:ring-1 focus:ring-[var(--pp-blue)]"
            />
          </div>
        </div>
